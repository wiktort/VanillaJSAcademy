...
const categories = {
    travel:{
        url: 'https://api.nytimes.com/svc/topstories/v2/travel.json?api-key=', 
        index: 0,
        data: []
    },
    food:{
        url: 'https://api.nytimes.com/svc/topstories/v2/food.json?api-key=', 
        index: 0,
        data: []
    },       
    technology:{
...
Object.keys(categories).map(key => {
    fetch(categories[key].url+api_key)
